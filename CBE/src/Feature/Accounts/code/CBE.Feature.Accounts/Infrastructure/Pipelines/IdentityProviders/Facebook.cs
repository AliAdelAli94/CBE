...
namespace CBE.Feature.Accounts.Infrastructure.Pipelines.IdentityProviders
{
    ...
    public class Facebook : IdentityProvidersProcessor
    {
        ...
        protected override void ProcessCore(IdentityProvidersArgs args)
        {
            ...
            var options = new FacebookAuthenticationOptions
            {
                ...
                AppId = Settings.GetSetting("CBE.Feature.Accounts.Facebook.AppId"),
                AppSecret = Settings.GetSetting("CBE.Feature.Accounts.Facebook.AppSecret"),
