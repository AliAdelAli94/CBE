namespace CBE.Feature.Accounts.Services
{
    ...
    public class AccountTrackerService : IAccountTrackerService
    {
        ...
        public static Guid LoginGoalId => Guid.Parse(Settings.GetSetting("CBE.Feature.Accounts.LoginGoalId", "{66722F52-2D13-4DCC-90FC-EA7117CF2298}"));
        public static Guid RegistrationGoalId => Guid.Parse(Settings.GetSetting("CBE.Feature.Accounts.RegistrationGoalId", "{8FFB183B-DA1A-4C74-8F3A-9729E9FCFF6A}"));
