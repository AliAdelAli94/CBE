...
namespace CBE.Feature.DiscussionForum.DAL.GenericRepository
{
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : class
    {
        internal DiscussionForumDbContext context;
        internal DbSet<TEntity> dbSet;

        public GenericRepository(DiscussionForumDbContext context)
        {
