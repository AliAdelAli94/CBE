namespace CBE.Feature.Search.Controllers
{
    using System.Linq;
    ...
    public class SearchController : Controller
    {
        ...
        {
            var facet = searchResults.Results.Facets.FirstOrDefault(f => f.Definition.FieldName == Foundation.Indexing.Constants.IndexFields.ContentType);
            var results = new
            {
